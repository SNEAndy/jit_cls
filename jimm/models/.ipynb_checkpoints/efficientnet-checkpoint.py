...
from .layers import create_conv2d, create_classifier, BatchNorm2d
...
default_cfgs = {
    ...
    'efficientnet_b4': _cfg(
        url='https://github.com/huggingface/pytorch-image-models/releases/download/v0.1-weights/efficientnet_b4_ra2_320-7eb33cd5.pth', 
    ...
    'efficientnet_el': _cfg(
        url='https://github.com/huggingface/pytorch-image-models/releases/download/v0.1-weights/efficientnet_el-3b455510.pth', 
        input_size=(3, 300, 300), pool_size=(10, 10), crop_pct=0.904),
...
class EfficientNet(nn.Module):
    ...
    def execute(self, x):
        ...
        if self.drop_rate > 0.:
            x = F.dropout(x, p=self.drop_rate, is_train=self.is_training())
...
def _gen_mnasnet_a1(variant, channel_multiplier=1.0, pretrained=False, **kwargs):
    ...
    model_kwargs = dict(
        ...
        norm_layer=partial(BatchNorm2d, **resolve_bn_args(kwargs)),
        **kwargs
    )
