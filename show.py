...
values = [0,0,0,0,0,0]
with open("data/supTrainSet/labels/trainval.txt",'r') as file:
...
# 添加标题和标签
plt.title('label-Analysis', fontsize=16)
...
plt.savefig('BrEAST_train.png', dpi=300, bbox_inches='tight')  # 保存为PNG格式，300DPI
# plt.savefig('bar_chart.pdf')  # 如需保存为PDF格式

print("柱状图已保存为 bar_chart_new.png")
# import os
# import json
# import glob
# import numpy as np
